  ...
  <div id="content">
    ...
    <div id="text" class="col-sm-11">
      <div id="rulesandreg">
        ...
        <ul>
          <fieldset>
          <h3 style="color: #428bce;">General</h3>
          <li>Students must wear/pin their student ID's before entering the ICS Library and during the stay inside the reading room.</li>
        ...
        <ul>
          <fieldset>
          <h3 style="color: #428bce;">Borrowing</h3>
