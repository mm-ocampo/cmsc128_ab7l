    ...
    <div id="width_limit">
      <div class="sidebar">
        ...
        <ul class="nav nav-sidebar ">          
          ...
          <li><a class="list-group-item active" href="/UI128/index.php/elib/admin_manage">Library Management<span class="glyphicon glyphicon-chevron-right pull-right"></span></a></li>
