...
In 1996, ICS instituted the Diploma in Computer Science both in residential and distance education modes while in 1998, the Ph.D. in Computer Science was instituted. In 2002, the Master of Information Technology was instituted.</p>
    ...
    <div id="float_right2">
      <!--SEARCH-->
     <div id="fixed">
      <form name="guest_search" class="form-signin" action="/UI128/index.php/site/callResults">
        <h2 class="form-signin-heading">Discover more</h2>
        <table>
          <tr>
            <td><div id="search_module"><?php include "search_home.php";?></div></td><!--<input type="text" name="search_query" class="search-query form-custom-search" placeholder="Search library"/></td>
