		...
		<div id="viewbook">
			...
			<div class="bookinfo">
				...
				<?php
					...
					echo "<form method=\"POST\" action=\"" . base_url(). "index.php/main/reservation\">";
					...
					else if($this->session->userdata('email')&&($this->session->userdata('books_reserved')<3)&&$row->status=='available') echo "<button class=\"btn btn-primary\" name=\"reserve\">Reserve</button>";
                    else{
