<?php
	...
	class Get_database extends CI_Model{
		...
		public function count_results(){
			...
			$pstmt = "SELECT distinct COUNT(title) result_count FROM material LEFT JOIN material_author ON material.accession_number = material_author.accession_number";
		...
		public function advanced_count_results(){
			...
			$pstmt = "SELECT distinct count(material.accession_number) result_count FROM material LEFT JOIN material_author ON material.accession_number = material_author.accession_number";
...
public function suggest(){
        ...
        public function get_reserve_search(){
            ...
            $pstmt = "SELECT accession_number FROM reserves where email='$email'";
