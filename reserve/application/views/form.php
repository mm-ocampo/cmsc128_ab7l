<form action="<?php echo base_url();?>index.php/site/search?page_number=1" method="get" accept-charset="utf-8">
    ...
    */
    ...
    <input type="text" autocomplete="off" id="search_bar"
        ...
        if(isset($_GET['search_query']) && $_GET['filter']!="subject")	echo "name='search_query' ";

        else if(isset($_GET['search_query']) && $_GET['filter']=="subject")echo "name='dummy' style='display:none'";
    ...
    <select id="search_subject"
        ...
        $query = "";
        if(isset($_GET['search_query']))		$query = $_GET['search_query'];
    ...
    <div id="checklist">
        ...
        <input type="checkbox" id="check1" value="book" name="format[]" <?php if(!isset($format))echo "checked"; else if($format[0]=="book")echo "checked";?>/><label for="check1"> Book</label>
        ...
        <input type="checkbox" id="check2" value="sp" name="format[]" <?php if($sp)	echo "checked";?>/><label for="check2"> SP</label><br/>
        <input type="checkbox" id="check3" value="thesis" name="format[]"<?php if($thesis)	echo "checked";?>/><label for="check3"> Thesis</label>
        <input type="checkbox" id="check4" value="journal" name="format[]"<?php if($journal)	echo "checked";?>/><label for="check4"> Journal</label>
