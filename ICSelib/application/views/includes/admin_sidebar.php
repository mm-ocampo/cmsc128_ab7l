<div class="sidebar">
  ...
  <ul class="nav nav-sidebar ">          
    ...
    <li><a class="list-group-item <?php if($this->input->get('page_number') == 2) echo "active";?>" href="<?php echo base_url();?>index.php/elib/admin_account?page_number=2"><i class="fa fa-users fa-lg space"></i>Accounts<i class="fa fa-chevron-right fa-lg space pull-right"></i></a></li>
    <li><a class="list-group-item <?php if($this->input->get('page_number') == 3) echo "active";?>" href="<?php echo base_url();?>index.php/elib/admin_manage?page_number=3"><i class="fa fa-cogs fa-lg space"></i>Library Management<i class="fa fa-chevron-right fa-lg space pull-right"></i></a></li>
