        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
              ...
              <li><a href="<?php echo base_url();?>index.php/query/load_view"><i class="fa fa-phone fa-lg space"></i>Contact Us</a></li>
              <li><a href="<?php echo base_url();?>index.php/elib/rules_and_regulations_view"><i class="fa fa-clipboard fa-lg space"></i>Library Rules</a></li>
            <li><a href="http://www.facebook.com/ICS.UPLB"><i class="fa fa-facebook-square fa-lg"></i></li></a>
