  ...
  <script type="text/javascript" language="javascript" src=<?php echo "\"".base_url()."assets/jquery-2.0.3.js"."\""?>></script>
    ...
    var author_counter = 1;
        window.onload = function(){
            ...
            material_form.type.focus();
            material_form.add_button.onclick = check_all_fields;
            ...
            material_form.copyright_year.onblur = validate_copyright_year;
        }
        ...
        function change_div(){
          ...
          function validate_title(){
            ...
            if(str == "")
              ...
              prompt = "Invalid input. Only Letters, Numbers, Spaces, Period and Hypen are allowed in this field.";
          ...
          function check_all_fields(){
            if(validate_author() && validate_title()){
              return true;
            }
            else{
              return false;
